...
int main(int argc, char* argv[]){
    ...
    string output_base_path = "./parser_result/";
    fs::create_directories(output_base_path);
    initialize();

    ifstream infile(input_file_path);
    //ifstream infile("circuit.v");
    ofstream edgefile(output_base_path+"edges.csv");
    ofstream nodefile(output_base_path+"nodetypes.csv");
    ofstream GNNedgefile(output_base_path+"GNNedges.csv");
    ofstream GNNnodefile(output_base_path+"GNNnodetypes.csv");
    ofstream GNNfeaturefile(output_base_path+"GNNfeature.csv");

    string output_info_base = output_base_path + "info/";
